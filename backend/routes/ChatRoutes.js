...
import { getMessagesByChat, postMessage, readAllMessages } from "../controller/MessageController.js";
const router = express.Router();

router.put("/:to_user", authMiddleware, connectionMiddleware, createOrGetChat);
router.get("/", authMiddleware, getAllChatsForUser);
router.get("/readall/:to_user", authMiddleware, connectionMiddleware, readAllMessages);
