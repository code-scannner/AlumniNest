import {
  ...
  import alumniPlaceholder from "@/assets/images/alumni.png";
  ...
  const AlumniSignup = () => {
    ...
    const handleSignup = async () => {
      ...
      try {
        const response = await axios.post("http://localhost:5000/api/alumni/signup", {
    ...
    return (
      <ScreenWrapper bg={"white"}>
        ...
        <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
          ...
          <Input placeholder="Batch (Year) *" onChangeText={(v) => (batchRef.current = v)} keyboardType="numeric" />
          <Input placeholder="Current Workplace" onChangeText={(v) => (currWorkRef.current = v)} />
          <Input placeholder="Position" onChangeText={(v) => (positionRef.current = v)} />
